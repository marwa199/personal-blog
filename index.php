            ...
            <div class="col-4 d-flex flex-column flex-wrap">
                ...
                <div class="py-5 my-5">
                    ...
                    <ul class="list-group list-group-flush text-start">
                      ...
                      <li class="list-group-item bg-transparent"><a href="categoried-articles.php?category=<?php echo $col['categoryName']; ?>" class=" btn link-secondary" target="_parent"><i class="fas fa-tags px-2"></i><?php echo $col['categoryName']; ?></a></li>
                ...
                <div class="py-5 mt-5 ">
                    ...
                    <ul class="list-group list-group-flush">
                      <?php
                        $stmt=$db->prepare("SELECT * FROM posts ORDER BY id DESC limit 4");
                        $stmt->execute();
                        $cols = $stmt->fetchAll();
                        foreach($cols as $col){
                      ?>
